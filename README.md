...
[Live demo on JSBin](http://jsbin.com/wapotedeja/1/)
...
| crop-area-bounds  | A model that will be automatically updated with the bounds of the crop area relative to the image. |
