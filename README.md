...
[Live demo on JSBin](http://jsbin.com/fukeqe/6/)
...
| crop-width (*optional*) | The minimum width that the crop area can be set to.
| crop-height (*optional*) | The minimum height that the crop area can be set to.
